...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-18 19:58:05 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Boundary-Aligned Contribution Routing for Robust Optical--SAR Object Detection》（9.0/10）, 《TinyDETR-Pose: Towards End-to-End Real-Time Single-Stage 6DoF Object Pose Estimation with Lightweight Transformers》（9.0/10）</p>
<p>速读：《PCT-Prompt: A Prompt-Guided Transformer Framework for Dense Prediction Tasks in Point Clouds》（7.0/10）, 《MergeOver: Post-Training Token Merging for Recursive Vision Transformers》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Boundary-Aligned Contribution Routing for Robust Optical--SAR Object Detection">Boundary-Aligned Contribution Routing for Robust Optical--SAR Object Detection</span></li><li><span class="dpr-home-dashboard-paper-title" title="TinyDETR-Pose: Towards End-to-End Real-Time Single-Stage 6DoF Object Pose Estimation with Lightweight Transformers">TinyDETR-Pose: Towards End-to-End Real-Time Single-Stage 6DoF Object Pose Estimation with Lightweight Transformers</span></li><li><span class="dpr-home-dashboard-paper-title" title="YOLO26-RD: An End-to-End Road Damage Detection Network With Learnable Contrast Enhancement and Edge-Guided Downsampling">YOLO26-RD: An End-to-End Road Damage Detection Network With Learnable Contrast Enhancement and Edge-Guided Downsampling</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="PCT-Prompt: A Prompt-Guided Transformer Framework for Dense Prediction Tasks in Point Clouds">PCT-Prompt: A Prompt-Guided Transformer Framework for Dense Prediction Tasks in Point Clouds</span></li><li><span class="dpr-home-dashboard-paper-title" title="MergeOver: Post-Training Token Merging for Recursive Vision Transformers">MergeOver: Post-Training Token Merging for Recursive Vision Transformers</span></li></ul>
  </div>
